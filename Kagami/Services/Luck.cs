...
public static class Luck
{
    private static readonly string[] routine =
    {
        ...
        "出门跑步", "吃华莱士", "水群", "点外卖", "发电", "打球", "翘课", "打牌", "刷批站", "看QQ", "写论文", "肝毕设", "骑车兜风", "看涩图", "ghs", "下棋",
        "刷网课", "当舔狗", "喝阔落", "打黄油", "出嫁", "搬家", "剁手", "开空调", "泡澡", "重启电脑", "跟人干架", "出门带伞", "走路看手机", "网抑云", "理发",
        "上学", "上班", "打电动", "炼丹", "修仙", "钓鱼", "被禁言", "看比赛", "睡午觉", "复读", "翻译腔说话", "下床", "YY群友", "看管人", "看纯爱本", "摆烂",
        "卖萌", "表白", "女装", "犯傻", "旅游", "吃冰棍", "开后宫", "吃辣条", "看NTR本", "画本子", "复习", "嗦粉", "调戏", "买菜", "讨价还价", "要求加薪",
        "上课发言", "堇业", "逛街", "挂机", "K歌", "试新衣服", "穿泳装", "去游泳", "吃瓜", "啖荔枝", "找人对线", "约会", "散步", "写日记", "打电话", "洗头",
        "做饭", "洗碗", "整理房间", "独处", "抱怨", "喝鸡汤", "吹牛", "逗猫猫", "求签", "荡秋千", "Debug", "与人争论", "给自己礼物", "听奥术魔刃"
    };
